          ...
          {courses.map((course) => (
            <Card key={course.id} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-md">
              <div className="relative overflow-hidden rounded-t-lg">
                ...
                />
                <Badge className="absolute top-4 left-4 bg-[#1e3a8a] hover:bg-[#1e3a8a]">{course.level}</Badge>
              </div>

              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-semibold text-gray-900 group-hover:text-[#1e3a8a] transition-colors">
                  {course.title}
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-2xl font-bold text-[#1e3a8a]">{course.price}</span>
                  </div>
                  <Button className="w-full bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white group">
                    Đăng ký ngay
