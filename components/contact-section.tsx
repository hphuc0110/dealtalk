            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  required
                  className="w-full border-gray-300 focus:border-[#1e3a8a] focus:ring-[#1e3a8a] transition-all duration-300"
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={4}
                  className="w-full border-gray-300 focus:border-[#1e3a8a] focus:ring-[#1e3a8a] transition-all duration-300 resize-none"
