          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <button
                ...
                className="text-gray-600 hover:text-[#1e3a8a] transition-colors duration-300 relative group"
              >
                Gói học
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Button
                ...
                className="bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white font-medium px-6 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                ĐĂNG KÝ NGAY
              </Button>
            </div>
            ...
            {/* Mobile menu button */}
            <button
              className="md:hidden text-gray-900 hover:text-[#1e3a8a] transition-colors duration-300"
          ...
          {isMenuOpen && (
            <div className="md:hidden animate-in slide-in-from-top-2 duration-300">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                <button
                  onClick={() => scrollToSection("curriculum")}
                  className="block w-full text-left px-3 py-2 text-gray-600 hover:text-[#1e3a8a] hover:bg-[#1e3a8a]/10 rounded-md transition-all duration-300"
                >
                  Gói học
                </button>
                <button
                ...
                <div className="px-3 py-2">
                  <Button
                    onClick={() => setIsRegistrationOpen(true)}
                    className="w-full bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white font-medium transition-all duration-300"
                  >
                    ĐĂNG KÝ NGAY
                  </Button>
                </div>
