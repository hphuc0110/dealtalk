  ...
  return (
    <section className="py-20 bg-white text-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="inline-block bg-[#1e3a8a] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-2xl sm:text-3xl font-bold shadow-lg ring-4 ring-yellow-500 ring-offset-4 ring-offset-[#000072]">
            Lộ trình 5+1 buổi
          </div>
      ...
      >
        <span className="text-sm sm:text-base font-bold text-white">
          ...
          <div className="hidden md:block relative mb-16">
            {/* Thanh nền */}
            <div className="absolute top-8 left-0 right-0 h-1 bg-[#1e3a8a] rounded-full" />
            {/* Thanh tiến trình */}
            <div
